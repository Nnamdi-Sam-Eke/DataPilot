          ...
          {safePreviewColumns.length > 0 && safePreviewRows.length > 0 && (
            ...
            >
              ...
              <div style={{ overflow: previewExpand.expanded ? "auto" : "auto", flex: previewExpand.expanded ? 1 : undefined, minHeight: 0 }}>
                ...
                {!previewExpand.expanded && safePreviewColumns.length > 6 && (
                  <div style={{ marginTop:8, fontSize:10, color:"var(--text3)" }}>
                    Showing 6 of {safePreviewColumns.length} columns · <button
                      onClick={previewExpand.toggle}
                      style={{ background:"none", border:"none", color:"var(--accent2)", cursor:"pointer", fontSize:10, padding:0, textDecoration:"underline" }}
                    >
                      expand to see all
                    </button>
                  </div>
