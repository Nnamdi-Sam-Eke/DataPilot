...
export default function PageTrain({ setPage }) {
  ...
  const startTrain = async () => {
    ...
    try {
      // Backend looks up plan (and the free-tier model limit) from the
      // verified auth token, so this needs the Firebase ID token or it
      // 401s before it ever gets to the plan check.
